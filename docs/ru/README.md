...
Набор включает в себя полётный контроллер с полётным стеком, [Orange Pi 5] в качестве управляющего бортового компьютера 
...
Платформа Eurus-Edu включает в себя преднастроенный [образ для Orange Pi 5] с полным набором необходимого ПО для работы со всей периферией. 
