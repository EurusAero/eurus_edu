...
![new_dataset_version](assets/dataset_annotation/new_dataset_version.png)

В отрывшемся окне задаём имя версии, на этапе "Processing" нажимаем continue.

![processing](assets/dataset_annotation/processing.png)
...
![augmentation](assets/dataset_annotation/augmentation.png)

После нажатия "Create" на 5 этапе будет создана версия датасета, которую нужно скачать, нажав на "Downland dataset"

![downland_dataset](assets/dataset_annotation/downland_dataset.png)
