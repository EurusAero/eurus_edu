...
Если вы используете нейронную сеть у себя на компьютере, убедитесь что у вас имеется .pt файл с весами вашей нейронной сети. Если вы используете нейронную сеть на Orange pi 5, то сперва вам нужно [экспортировать модель](./neural_network_export.md) в поддержвиаемый для Rockchip 3588 тип.
...
Помимо этого в source можно указать множество различных других источников, например ссылки на каритнку в интернете, путь к видео или путь к папке где хранится несколько картинок или видео.
