# Работа с Orange Pi 5B

**Orange Pi 5B** — одноплатный компьютер на базе восьмиядерного процессора Rockchip RK3588S.
...
![orangepi](assets/orangepi/orangepi_image.png)
...
![pinout](assets/orangepi/pinout.png)

В Eurus-Edu Orange Pi 5B подключается к полётному контроллеру и используется как вспомогательный компьютер. Он позволяет подключаться к дрону по Wi-Fi, программировать автономные полёты, работать с периферией и многое другое.
