...
<span style="color:red"> ОБЯЗАТЕЛЬНО: Перед пайкой и подключением проверьте конфигурацию напряжения на понижающем преобразователе. На контактной площадке ADJ перемычка (капля припоя) должна быть установлена строго на значение 5V <span>
