...
3. Устанавливаем моторы на соответствующие отверстия в луче при помощи винтов M3x6, которые идут в комплекте с моторами.
...
После подключения проводов, приёмник в термоусадке приклеить на двусторонний скотч как показано на схеме. Антену закрепить с помощию двух стяжек крест накрест под лучом.
