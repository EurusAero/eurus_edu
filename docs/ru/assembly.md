...
5. Сборка и установка полётного контроллера (FC) и регулятора оборотов (ESC)
    ...
    5.1 На центральную раму устанавливаем 4 винта M3x25, закрепляя гайками M3
    ...
    5.3 Устанавливаем FC, предварительно надев на него демпферные резинки. Закрепляем нейлоновыми гайками M3

    ![5.3](assets/neural_network_train/assembly/5.3.png)

6. Установите металлические стойки 30мм на лучах, фиксируя винтами M3x14 (HEX).На них закрепите верхнюю платформу используя винты M3x8 (НЕX)

![6.1](assets/neural_network_train/assembly/6.1.png)
