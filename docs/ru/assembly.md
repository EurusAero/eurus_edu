...
<span style="color:red"> ОБЯЗАТЕЛЬНО: Перед пайкой и подключением проверьте конфигурацию напряжения на понижающем преобразователе. На контактной площадке ADJ перемычка (капля припоя) должна быть установлена строго на значение 5V (на изображении выделено красным) <span>

![8.7](assets/assembly/8.7.png)

Если припой находится на другом значении или отсутствует, преобразователь выдаст неверное напряжение, что может вывести из строя одноплатный компьютер
...
1\. Установите камеру на оставшиеся стойки нижней панели, располагая контактами для пайки ближе к USB-разъёму. Закрепите нейлоновыми гайками. Подключите камеру к одноплатному компьютеру через USB-порт.
