...
1\. Загрузите бинарный файл загрузчика [kakuteh7_bl.hex](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_controller/kakuteh7/holybro_kakuteh7_bootloader.hex), при сохранении выбирая "все файлы"
...
6\. нажмите на кнопку загрузить прошивку (Local) на нижней панели, выберите скачанный ранее файл bootloader. 
